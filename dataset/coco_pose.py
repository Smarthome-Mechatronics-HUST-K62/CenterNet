...
class COCOHP(Dataset):
    ...
    def __getitem__(self,idx):
        ...
        annos = list(filter(lambda x : x['iscrowd'] != 1, annos))
        ...
        ret = {
            ...
            "hps": kps, #(max_objs,num_joints * 2) : distance_x, distance_y from keypoints to center
            "hps_mask": kps_mask, #(max_objs,num_joints * 2)
